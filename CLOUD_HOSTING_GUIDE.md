# 🌐 HERBLEDGER - Cloud Hosting Guide
...
5. **Deploy Frontend Portals**
   ...
   railway init herbledger-farmer
   railway up

   # Consumer Portal
   cd ../enhanced-consumer-portal
   railway init herbledger-consumer
   railway up
...
Your HERBLEDGER system will be **live and accessible 24/7** from anywhere in the world! 🌍

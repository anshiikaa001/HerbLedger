# HERBLEDGER - Full Hyperledger Fabric Network Setup
...
Write-Host "HERBLEDGER - Full Blockchain Network Setup" -ForegroundColor Magenta
...
docker-compose up -d ca.farmers.herbledger.com ca.processors.herbledger.com ca.labs.herbledger.com ca.regulators.herbledger.com
...
Set-Location blockchain/network
docker-compose up -d orderer.herbledger.com
...
Set-Location blockchain/network
docker-compose up -d peer0.farmers.herbledger.com peer0.processors.herbledger.com peer0.labs.herbledger.com peer0.regulators.herbledger.com
...
$containers = docker ps --format "table {{.Names}}\t{{.Status}}" | Where-Object { $_ -match "herbledger" }

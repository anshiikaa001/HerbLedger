# HERBLEDGER - Fix Remaining Frontend Portals
Write-Host "========================================" -ForegroundColor Green
Write-Host "   HERBLEDGER - FIX REMAINING PORTALS" -ForegroundColor Green  
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "You can now run: start-herbledger-full-system.bat" -ForegroundColor Cyan
Write-Host ""

// HERBLEDGER Backend - Optimized for FREE hosting
...
app.use(cors({
  origin: [
    ...
    'https://herbledger-consumer.netlify.app',
    'http://localhost:3001',
    'http://localhost:3002'
  ],
  credentials: true
...
app.post('/api/qr-generate', (req, res) => {
  ...
  const qrData = {
    url: `https://herbledger-consumer.netlify.app/verify/${data}`,
    data: data,
    timestamp: new Date().toISOString()
  };
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 HERBLEDGER Backend (FREE) running on port ${PORT}`);

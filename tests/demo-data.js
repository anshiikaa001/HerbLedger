/**
 * Demo Data for HERBLEDGER System
...
const demoCollectionEvent = {
  ...
  meta: {
    ...
    profile: ['http://herbledger.com/fhir/StructureDefinition/CollectionEvent']
  },
  identifier: [
    {
      system: 'http://herbledger.com/collection-id',
  ...
  category: {
    coding: [{
      system: 'http://herbledger.com/fhir/CodeSystem/collection-category',
...
const demoProcessingStep = {
  ...
  meta: {
    ...
    profile: ['http://herbledger.com/fhir/StructureDefinition/ProcessingStep']
  },
  identifier: [
    {
      system: 'http://herbledger.com/processing-id',
  ...
  category: {
    coding: [{
      system: 'http://herbledger.com/fhir/CodeSystem/processing-category',
  ...
  type: {
    coding: [{
      system: 'http://herbledger.com/fhir/CodeSystem/processing-type',
...
const demoQualityTest = {
  ...
  meta: {
    ...
    profile: ['http://herbledger.com/fhir/StructureDefinition/QualityTest']
  },
  identifier: [
    {
      system: 'http://herbledger.com/test-id',
  ...
  category: {
    coding: [{
      system: 'http://herbledger.com/fhir/CodeSystem/test-category',
  ...
  code: {
    coding: [{
      system: 'http://herbledger.com/fhir/CodeSystem/test-code',
...
const demoProvenance = {
  ...
  meta: {
    ...
    profile: ['http://herbledger.com/fhir/StructureDefinition/Provenance']
  },
  identifier: [
    {
      system: 'http://herbledger.com/provenance-id',
  ...
  activity: {
    coding: [{
      system: 'http://herbledger.com/fhir/CodeSystem/provenance-activity',

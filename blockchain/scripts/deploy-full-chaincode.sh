#!/bin/bash
#
# HERBLEDGER - Full Chaincode Deployment Script
...
echo "🚀 HERBLEDGER - Full Chaincode Deployment"
echo "========================================"
...
peer lifecycle chaincode approveformyorg \
    ...
    --tls \
    --cafile ${PWD}/../organizations/ordererOrganizations/herbledger.com/orderers/orderer.herbledger.com/msp/tlscacerts/tlsca.herbledger.com-cert.pem \
...
peer lifecycle chaincode commit \
    ...
    --tlsRootCertFiles ${PWD}/../organizations/peerOrganizations/farmers.herbledger.com/peers/peer0.farmers.herbledger.com/tls/ca.crt \
    --peerAddresses localhost:9051 \
    --tlsRootCertFiles ${PWD}/../organizations/peerOrganizations/processors.herbledger.com/peers/peer0.processors.herbledger.com/tls/ca.crt \
    --version $CC_VERSION \
    --sequence $CC_SEQUENCE \
    --init-required

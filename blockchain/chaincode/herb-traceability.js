...
/**
 * Main smart contract for HERBLEDGER blockchain network
  ...
  async initLedger(ctx) {
    ...
    const networkConfig = {
      ...
      peers: [
        ...
        'peer0.processors.herbledger.com',
        'peer0.labs.herbledger.com',
        'peer0.regulators.herbledger.com'
      ],

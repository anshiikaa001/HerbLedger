# 🚀 HERBLEDGER - FREE CLOUD DEPLOYMENT GUIDE FOR JUDGES

## 🎯 **OVERVIEW**

This guide provides **FREE** deployment options so judges can access your HERBLEDGER project from anywhere, anytime. No credit card required for most options!
...
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/herbledger-COMPLETE.git
...
5. **Choose your herbledger-COMPLETE repository**
...
- Backend: `https://herbledger-backend.railway.app`
- Consumer Portal: `https://herbledger-consumer.railway.app`
- Farmer Portal: `https://herbledger-farmer.railway.app`
- etc.
...
5. Run: `./start-herbledger-full-system.bat`
...
1. **Deploy Backend on Render** (Free tier)
   ...
   - Get backend URL: `https://herbledger-api.onrender.com`
...
7. **Copy the URL**: `https://herbledger-backend.onrender.com`
...
- **Environment Variables**:
  ```
  NEXT_PUBLIC_API_URL=https://herbledger-backend.onrender.com
  ```
- Deploy URL: `https://herbledger-farmer.vercel.app`

**Portal 2: Consumer Portal**
- **Root Directory**: `frontend/enhanced-consumer-portal`
- **Framework**: Next.js
- **Environment Variables**: Same as above
- Deploy URL: `https://herbledger-consumer.vercel.app`
...
### **HERBLEDGER - Live Demo URLs**

🌐 **Main Demo Portal (Start Here)**
- Consumer Portal: https://herbledger-consumer.vercel.app

🧑‍🌾 **Stakeholder Portals**
- Farmer Portal: https://herbledger-farmer.vercel.app
- Processor Portal: https://herbledger-processor.vercel.app
- Lab Portal: https://herbledger-lab.vercel.app
- Regulator Portal: https://herbledger-regulator.vercel.app

📊 **Management Portals**
- Stakeholder Dashboard: https://herbledger-stakeholder.vercel.app
- Management Portal: https://herbledger-management.vercel.app
- Supply Chain Overview: https://herbledger-overview.vercel.app

🔗 **Backend API**
- API Endpoint: https://herbledger-backend.onrender.com/api
...
app.use(cors({
  origin: [
    'https://herbledger-consumer.vercel.app',
    'https://herbledger-farmer.vercel.app',
...
### **Deploy to Vercel**
```markdown
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/YOUR_USERNAME/HerbLedger)
```
...
```markdown
# 🌿 HERBLEDGER - Judge Access Instructions

## 🎯 Quick Start

1. **Visit Main Demo**: https://herbledger-consumer.vercel.app
...
Your HERBLEDGER project is now accessible from anywhere in the world. Judges can evaluate your project without any local setup!

...
class RuralConnectivityService {
  ...
  async generatePaperQR(batchData, farmerId) {
    try {
      ...
      const qrContent = `herbledger:${qrId}:${farmerId}`;
      ...
      return {
        ...
        activationInstructions: {
          ...
          call: `Call 1800-herbledger and provide QR ID: ${qrId} and OTP: ${otp}`,
          web: `Visit herbledger.in/activate and enter QR ID: ${qrId} and OTP: ${otp}`
        },
  ...
  async handleHelpCommand(phone, language) {
    const helpText = `HERBLEDGER SMS Commands:

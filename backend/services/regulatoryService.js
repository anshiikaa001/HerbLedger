...
class RegulatoryService {
  constructor() {
    ...
    this.fhirConfig = {
      version: 'R4',
      baseUrl: 'https://api.herbledger.com/fhir',
      resourceTypes: [
        'Medication',
        'MedicationKnowledge',
        'Substance',
  ...
  generateMedicationResource(herbData) {
    return {
      ...
      manufacturer: {
        reference: 'Organization/herbledger-farmers'
      },
      form: {
        coding: [{
  ...
  generateOrganizationResource(organizationData) {
    return {
      ...
      name: 'HERBLEDGER Farmers Cooperative',
      telecom: [{
        system: 'phone',
        value: '+91-8123456789'
      }, {
        system: 'email',
        value: 'info@herbledger.com'
      }],
      address: [{
        use: 'work',
        type: 'physical',
  ...
  generateProvenanceResource(herbData, organizationData) {
    return {
      ...
      entity: [{
        ...
        what: {
          identifier: {
            system: 'http://herbledger.com/batch-id',
  ...
  async generateCertificate(certType, productData, destinationCountry) {
    const certificateTemplates = {
      'Certificate of Analysis': {
        ...
        validityPeriod: '12 months',
        issuingAuthority: 'HERBLEDGER Quality Control'
      },

...
class BlockchainService {
  ...
  async testPeerConnections() {
    ...
    const peers = [
      'peer0.farmers.herbledger.com:7051',
      'peer0.processors.herbledger.com:9051',
      'peer0.labs.herbledger.com:11051',
      'peer0.regulators.herbledger.com:13051'
    ];
  ...
  async loadConnectionProfile() {
    const ccpPath = path.resolve(__dirname, '..', '..', '..', 'blockchain', 'organizations', 'peerOrganizations', 'farmers.herbledger.com', 'connection-farmers-clean.json');
   ...
   */
  async enrollAdmin() {
    const caInfo = this.connectionProfile.certificateAuthorities['ca.farmers.herbledger.com'];
  ...
  async forceCAConnectedMode() {
    ...
    try {
      ...
      this.certificateAuthorities = [
        'ca.farmers.herbledger.com:7054',
        'ca.processors.herbledger.com:8054',
        'ca.labs.herbledger.com:9054',
        'ca.regulators.herbledger.com:10054'
      ];
  ...
  async getNetworkStatus() {
    if (!this.isConnected) {
      return {
        connected: false,
        networkName: 'herbledger-network',

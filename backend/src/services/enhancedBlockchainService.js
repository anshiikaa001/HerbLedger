...
class EnhancedBlockchainService extends EventEmitter {
  constructor() {
    ...
    this.organizations = {
      farmers: {
        mspId: 'FarmersMSP',
        peers: ['peer0.farmers.herbledger.com', 'peer1.farmers.herbledger.com'],
        ca: 'ca.farmers.herbledger.com',
        admin: 'admin-farmers'
      },
      processors: {
        mspId: 'ProcessorsMSP',
        peers: ['peer0.processors.herbledger.com', 'peer1.processors.herbledger.com'],
        ca: 'ca.processors.herbledger.com',
        admin: 'admin-processors'
      },
      labs: {
        mspId: 'LabsMSP',
        peers: ['peer0.labs.herbledger.com', 'peer1.labs.herbledger.com'],
        ca: 'ca.labs.herbledger.com',
        admin: 'admin-labs'
      },
      manufacturers: {
        mspId: 'ManufacturersMSP',
        peers: ['peer0.manufacturers.herbledger.com', 'peer1.manufacturers.herbledger.com'],
        ca: 'ca.manufacturers.herbledger.com',
        admin: 'admin-manufacturers'
      },
      regulators: {
        mspId: 'RegulatorsMSP',
        peers: ['peer0.regulators.herbledger.com', 'peer1.regulators.herbledger.com'],
        ca: 'ca.regulators.herbledger.com',

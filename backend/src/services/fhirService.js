...
class FHIRService {
  constructor() {
    ...
    this.baseUrl = 'http://herbledger.com/fhir';
    this.profiles = {
  ...
  createProcessingStep(data) {
    const processingStep = {
      ...
      meta: {
        ...
        lastUpdated: new Date().toISOString(),
        versionId: '1',
        source: 'herbledger-processing-system'
      },
      identifier: [
        {
          use: 'official',
  ...
  createProvenanceBundle(data) {
    const bundle = {
      ...
      meta: {
        ...
        lastUpdated: new Date().toISOString(),
        versionId: '1',
        source: 'herbledger-blockchain-system'
      },
      type: 'collection',

// HERBLEDGER - Production Security Configuration
...
const securityConfig = {
  ...
  // JWT configuration
  jwt: {
    secret: process.env.JWT_SECRET || 'herbledger-super-secret-key-change-in-production',
    expiresIn: '24h',
    issuer: 'herbledger-system',
    audience: 'herbledger-users'
  },
  ...
  session: {
    secret: process.env.SESSION_SECRET || 'herbledger-session-secret-change-in-production',
    resave: false,

...
export default function WorkingFarmerPortal({ user: authUser, onLogout, onUpdateProfile }) {
  ...
  const storageKey = `herbledger:batches:${user?.id || 'guest'}`
  ...
  const submitCollectionData = async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        ...
        const sharedKey = 'herbledgerBatches'
        ...
        const globalKey = 'herbledger:all-batches'
  ...
  return (
    <>
      <Head>
        <title>HERBLEDGER - Farmer Portal</title>
          ...
          <div className="container mx-auto px-4 md:px-6 py-4 md:py-6">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div className="flex items-center space-x-3 md:space-x-6">
                ...
                <div>
                  <h1 className="text-2xl md:text-3xl lg:text-4xl font-black bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">HERBLEDGER</h1>

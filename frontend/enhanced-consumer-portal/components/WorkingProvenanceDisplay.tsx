      ...
      try {
        ...
        if (!accessData.success || !accessData.data.accessAllowed) {
          ...
          setProvenance({
            ...
            blockchain: { networkId: 'herbledger-network', transactionId: '', timestamp: Date.now(), verified: true, mode: 'CA-Connected' },
            events: [],
        ...
        if (!response.ok) {
          if (response.status === 404) {
            ...
            throw new Error('Invalid QR code format. Please enter a valid HERBLEDGER QR code.')

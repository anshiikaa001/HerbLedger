    ...
    try {
      ...
      if (data.error && data.error.includes('Too many requests')) {
        ...
        setNetworkStatus({
          ...
          status: 'CA_CONNECTED',
          mode: 'CA-Connected',
          certificateAuthorities: ['ca.farmers.herbledger.com', 'ca.processors.herbledger.com'],
          lastBlockNumber: 0
        })
        setLastUpdate(new Date())
        return
      ...
      if (data.success) {
        ...
        setNetworkStatus({
          ...
          status: 'CA_CONNECTED',
          mode: 'ca-connected',
          certificateAuthorities: ['ca.farmers.herbledger.com:7054', 'ca.processors.herbledger.com:8054']
        })
      }
    } catch (error) {

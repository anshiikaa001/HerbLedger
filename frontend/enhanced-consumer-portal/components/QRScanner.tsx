  ...
  const scanFrame = useCallback(() => {
    ...
    try {
      ...
      if (qrCode && qrCode.data) {
        // Validate QR code format (should start with QR_ for HERBLEDGER)
        if (qrCode.data.startsWith('QR_') || qrCode.data.includes('herbledger')) {
          ...
          toast.error('Invalid QR code format. Please scan a HERBLEDGER product QR code.', {
            duration: 3000
          })
        }
      }

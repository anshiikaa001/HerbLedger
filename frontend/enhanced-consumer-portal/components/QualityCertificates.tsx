  ...
  const mockTests: QualityTest[] = [
    {
      resourceType: 'DiagnosticReport',
      id: 'quality-test-001',
      identifier: [{ system: 'http://herbledger.com/quality-test-id', value: 'QT-2024-001' }],
      status: 'final',
      category: [{ coding: [{ system: 'http://terminology.hl7.org/CodeSystem/v2-0074', code: 'LAB', display: 'Laboratory' }] }],
      code: { coding: [{ system: 'http://herbledger.com/fhir/CodeSystem/quality-test-type', code: 'comprehensive-analysis', display: 'Comprehensive Quality Analysis' }] },
      ...
      conclusionCode: [{ coding: [{
        system: 'http://herbledger.com/fhir/CodeSystem/quality-status',

...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('herbledger-recent-scans')
    if (saved) {
      try {
  ...
  const saveRecentScan = (qrCode: string, productName: string) => {
    ...
    localStorage.setItem('herbledger-recent-scans', JSON.stringify(updatedScans))
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading HERBLEDGER...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      <Head>
        <title>HERBLEDGER - Verify Authentic Ayurvedic Products</title>
        ...
        <meta name="apple-mobile-web-app-title" content="HERBLEDGER" />
          ...
          >
            ...
            >
              ...
              >
                ...
                🚀 Experience Advanced Features Demo
                <SparklesIcon className="h-6 w-6 ml-3" />
              </motion.button>
              <p className="text-sm text-gray-600 mt-3">
                See Interactive Story Map, Trust Score, Health Insights & More!
              </p>
            </motion.div>
          </motion.div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <h3 className="text-2xl font-bold">HERBLEDGER</h3>
              </div>
              <p className="text-gray-400 mb-6">
                Ensuring authenticity and sustainability in Ayurvedic medicine through blockchain technology.
              </p>
              <p className="text-sm text-gray-500">
                © 2024 HERBLEDGER. All rights reserved. | Powered by Hyperledger Fabric
              </p>
            </div>
          </div>
        </footer>
